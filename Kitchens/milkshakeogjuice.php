...
<meta name="keywords" content="Aarhus, street food, Milkshake og Juice, mad, drikke, spisested">
<meta name="author" content="Andreas Nielsen, Emma Schumacher, Mathilde Gladov, Michael Rønne">
<title>Milkshake og Juice | Aarhus Street Food</title>
...
<section class="profile">
	<h1 class="hidden-xs">Milkshake og Juice</h1>
	<div class="breadcrumb hidden-xs col-sm-offset-1 col-sm-1 col-md-offset-2 col-md-1 col-lg-offset-2 col-lg-1">
		<a href="../index.php">Køkkener / </a>Milkshake og Juice
	</div>
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 content">
		<img class="img-responsive" alt="Milkshake og Juice hero-billede" src="../img/kitchens/milkshakeogjuice.jpg">	
		<h1 class="visible-xs xs-h1">Milkshake og Juice</h1>
		...
		<article class="profiletext col-md-12">
			...
			<div class="profilesome">
				...
				<a href="404" title="Twitter"><img alt="Twitter logo" src="../img/icons/twitterlogo.png"></a>
				<a href="404" title="hjemmeside"><img alt="WWW logo" src="../img/icons/www.png"></a>
			</div>
		</article>
	</div>
