...
<meta name="keywords" content="Aarhus, street food, Ugood, mad, drikke, spisested">
<meta name="author" content="Andreas Nielsen, Emma Schumacher, Mathilde Gladov, Michael Rønne">
<title>Ugood | Aarhus Street Food</title>
...
<section class="profile">
	<h1 class="hidden-xs">Ugood</h1>
	<div class="breadcrumb hidden-xs col-sm-offset-1 col-sm-1 col-md-offset-2 col-md-1 col-lg-offset-2 col-lg-1">
		<a href="../index.php">Køkkener / </a>Ugood
	</div>
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 content">
		<img class="img-responsive" alt="Ugood hero-billede" src="../img/kitchens/ugood.jpg">	
		<h1 class="visible-xs xs-h1">Ugood</h1>
		<h2>U Good B Good</h2>	
		<article class="profiletext col-md-12">
			...
			<div class="profilesome">
				<a href="https://www.facebook.com/Ugood" title="Facebook"><img alt="facebooklogo" src="../img/icons/facebooklogo.png"></a>
