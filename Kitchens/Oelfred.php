...
<meta name="keywords" content="Aarhus, street food, Ølfred, mad, drikke, spisested">
<meta name="author" content="Andreas Nielsen, Emma Schumacher, Mathilde Gladov, Michael Rønne">
<title>Ølfred | Aarhus Street Food</title>
...
<section class="profile">
	...
	<div class="breadcrumb col-xs-1 col-xs-offset-1 col-sm-offset-1 col-sm-1 col-md-offset-2 col-md-1 col-lg-offset-2 col-lg-1">
		<a href="../index.php">Køkkener / </a>Ølfred
	</div>
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-8 content">
			
		<img class="img-responsive" alt="Ølfred hero-billede" src="../img/kitchens/oelfred1.jpg">	
		<h2>Øl til alt og alle!</h2>	
		<article class="profiletext col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
			
			<p>Ølfred er ølbaren med plads til øl og alle.  Sortimentet udskiftes løbende, så der er altid noget nyt, friskt og spændende til de ølhungrende.</p>
