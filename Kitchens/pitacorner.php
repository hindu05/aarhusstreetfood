...
<meta name="keywords" content="Aarhus, street food, Pita Corner, mad, drikke, spisested">
<meta name="author" content="Andreas Nielsen, Emma Schumacher, Mathilde Gladov, Michael Rønne">
<title>Pita Corner | Aarhus Street Food</title>
...
<section class="profile">
	<h1 class="hidden-xs">Pita Corner</h1>
	<div class="breadcrumb hidden-xs col-sm-offset-1 col-sm-1 col-md-offset-2 col-md-1 col-lg-offset-2 col-lg-1">
		<a href="../index.php">Køkkener / </a>Pita Corner
	</div>
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 content">
		<img class="img-responsive" alt="Pita Corner hero-billede" src="../img/kitchens/pitacorner.jpg">	
		<h1 class="visible-xs xs-h1">Pita Corner</h1>
