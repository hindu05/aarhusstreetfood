...
<meta name="keywords" content="Aarhus, street food, La Pasta Fresca, mad, drikke, spisested">
<meta name="author" content="Andreas Nielsen, Emma Schumacher, Mathilde Gladov, Michael Rønne">
<title>La Pasta Fresca | Aarhus Street Food</title>
...
<section class="profile">
	<h1 class="hidden-xs">La Pasta Fresca</h1>
	<div class="breadcrumb hidden-xs col-sm-offset-1 col-sm-1 col-md-offset-2 col-md-1 col-lg-offset-2 col-lg-1">
		<a href="../index.php">Køkkener / </a>La Pasta Fresca
	</div>
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 content">
		<img class="img-responsive" alt="La Pasta Fresca hero-billede" src="../img/kitchens/lapastafresca.jpg">	
		<h1 class="visible-xs xs-h1">La Pasta Fresca</h1>
